...
render('div.taskRHS:not(.timechimp), div.row-rightElements:not(.timechimp)', {observe: true}, function (elem) {
    ...
    if (container === null) {
        ...
        if (container === null) {
            ...
            elem.classList.remove('timechimp');
            return;
        }
    }
    ...
    if (isTKO) {
        ...
        link.addEventListener('click', function () {
            ...
            var i, len, elems = document.querySelectorAll(".timechimp-button");
    ...
    spanTag.classList.add("timechimp-span");
    ...
    link.setAttribute("title", "timechimp Timer");
...
render('div#Task div.titleHolder ul.options:not(.timechimp), .view-header ul.task-details-options:not(.timechimp)', {observe: true}, function (elem) {
    var link, liTag, desc,
        project = $("#projectName > span").textContent;

    liTag = document.createElement("li");
    liTag.classList.add("timechimp-li");
